...
# Kumpulan path SVG outline (gaya Heroicons) supaya semua ikon di seluruh
# halaman konsisten dengan referensi desain Google Stitch, menggantikan emoji.
ICONS = {
    ...
    'chart-bar': '<path stroke-linecap="round" stroke-linejoin="round" d="M3 13.125c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125v6.75C7.5 20.496 6.996 21 6.375 21h-2.25A1.125 1.125 0 0 1 3 19.875v-6.75ZM9.75 8.625c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125v11.25c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 0 1-1.125-1.125V8.625ZM16.5 4.125c0-.621.504-1.125 1.125-1.125h2.25C20.496 3 21 3.504 21 4.125v15.75c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 0 1-1.125-1.125V4.125Z" />',
    ...
    'help': '<path stroke-linecap="round" stroke-linejoin="round" d="M9.879 7.519c1.171-1.025 3.071-1.025 4.242 0 1.172 1.025 1.172 2.687 0 3.712-.203.179-.43.326-.67.442-.745.361-1.45 1.005-1.45 1.827v.75M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" /><path stroke-linecap="round" stroke-linejoin="round" d="M12 17.25h.008v.008H12v-.008Z" />',
    ...
    'upload': '<path stroke-linecap="round" stroke-linejoin="round" d="M3 16.5v2.25A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75V16.5M16.5 12 12 7.5 7.5 12M12 7.5v9" />',
    'download': '<path stroke-linecap="round" stroke-linejoin="round" d="M3 16.5v2.25A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75V16.5M7.5 12 12 16.5l4.5-4.5M12 16.5V3" />',
    ...
    'fire': '<path stroke-linecap="round" stroke-linejoin="round" d="M15.362 5.214A8.252 8.252 0 0 1 12 21 8.25 8.25 0 0 1 6.038 7.047 8.287 8.287 0 0 0 9 9.601a8.983 8.983 0 0 1 3.361-6.867 8.21 8.21 0 0 0 3 2.48Z" /><path stroke-linecap="round" stroke-linejoin="round" d="M9.75 14.25a3.75 3.75 0 1 1 7.5 0 3.75 3.75 0 0 1-7.5 0Z" />',
    'folder': '<path stroke-linecap="round" stroke-linejoin="round" d="M2.25 12.75V12A2.25 2.25 0 0 1 4.5 9.75h15A2.25 2.25 0 0 1 21.75 12v.75m-19.5 0v6a2.25 2.25 0 0 0 2.25 2.25h15a2.25 2.25 0 0 0 2.25-2.25v-6m-19.5 0V8.25A2.25 2.25 0 0 1 4.5 6h3.879a1.5 1.5 0 0 1 1.06.44l1.122 1.12a1.5 1.5 0 0 0 1.06.44H19.5a2.25 2.25 0 0 1 2.25 2.25v.75" />',
    ...
    'inbox': '<path stroke-linecap="round" stroke-linejoin="round" d="M2.25 13.5h3.86a2.25 2.25 0 0 1 2.012 1.244l.256.512a2.25 2.25 0 0 0 2.013 1.244h3.218a2.25 2.25 0 0 0 2.013-1.244l.256-.512a2.25 2.25 0 0 1 2.013-1.244h3.859m-19.5.338V18a2.25 2.25 0 0 0 2.25 2.25h15A2.25 2.25 0 0 0 21.75 18v-4.162c0-.224-.034-.447-.1-.661L19.24 5.34A2.25 2.25 0 0 0 17.15 3.75H6.85a2.25 2.25 0 0 0-2.09 1.59l-2.41 7.836a2.25 2.25 0 0 0-.1.661Z" />',
    'cloud-upload': '<path stroke-linecap="round" stroke-linejoin="round" d="M12 9v6m3-3-3-3-3 3m-2.25 6A4.5 4.5 0 0 1 2.25 12 4.5 4.5 0 0 1 7 7.5h.5a5.25 5.25 0 0 1 10.5 0h.5a3.75 3.75 0 0 1 .088 7.488" />',
    ...
    'infinity': '<path stroke-linecap="round" stroke-linejoin="round" d="M6 9a3 3 0 1 0 0 6c1.5 0 2.7-1 3.5-2.2.4-.6.7-1.2 1-1.8.3.6.6 1.2 1 1.8.8 1.2 2 2.2 3.5 2.2a3 3 0 1 0 0-6c-1.5 0-2.7 1-3.5 2.2-.4.6-.7 1.2-1 1.8-.3-.6-.6-1.2-1-1.8C8.7 10 7.5 9 6 9Z" />',
    ...
    'badge-check': '<path stroke-linecap="round" stroke-linejoin="round" d="m9 12.75 1.5 1.5 3-3.75M21 12c0 1.268-.63 2.39-1.593 3.068a3.745 3.745 0 0 1-1.043 3.296 3.745 3.745 0 0 1-3.296 1.043A3.745 3.745 0 0 1 12 21c-1.268 0-2.39-.63-3.068-1.593a3.746 3.746 0 0 1-3.296-1.043 3.745 3.745 0 0 1-1.043-3.296A3.745 3.745 0 0 1 3 12c0-1.268.63-2.39 1.593-3.068a3.745 3.745 0 0 1 1.043-3.296 3.746 3.746 0 0 1 3.296-1.043A3.746 3.746 0 0 1 12 3c1.268 0 2.39.63 3.068 1.593a3.746 3.746 0 0 1 3.296 1.043 3.746 3.746 0 0 1 1.043 3.296A3.745 3.745 0 0 1 21 12Z" />',
}


@register.simple_tag
def icon(name, size=18, css_class=''):
    """Render ikon outline SVG (gaya Heroicons) menggantikan emoji."""
    path = ICONS.get(name, '')
